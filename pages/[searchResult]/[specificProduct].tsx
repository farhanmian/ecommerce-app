...
const SpecificProduct = () => {
  ...
  const productId = `/${router.query.searchResult}/${router.query.specificProduct}`;
  ...
  return product ? (
    <React.Fragment>
      <Header heading="Product Details" path="Product Details" />
            ...
            <React.Fragment>
              ...
              <div className={styles.specificProductTextContainer}>
                ...
                <Typography
                  className={classes.color151875}
                  variant="body2"
                  style={{ fontFamily: "Josefin Sans", marginBottom: 10 }}
                >
